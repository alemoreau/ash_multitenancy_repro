...
config :my_app, MyAppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "8dnZQnjY5yPd/4hjLWT/SVCL+mKDe+BKKOrF47dx8phRJd5dlix3CfG0qbYO9hPm",
  watchers: [
...
config :my_app, dev_routes: true, token_signing_secret: "u3UQ4n9it98mfxefcXl5SyW2bjUxQF9x"
